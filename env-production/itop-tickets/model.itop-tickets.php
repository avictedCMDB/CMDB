						<?php
//
// File generated by ... on the 2018-08-22T10:35:53+0200
// Please do not edit manually
//

/**
 * Classes and menus for itop-tickets (version 2.4.0)
 *
...
abstract class Ticket extends _Ticket
{
	public static function Init()
	{
		...
		(
			...
			'obsolescence_expression' => 'operational_status=\'closed\' AND (close_date < DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 15 MONTH),\'%Y-%m-%d 00:00:00\') OR (ISNULL(close_date) AND last_update < DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 15 MONTH),\'%Y-%m-%d 00:00:00\')))',
		);
